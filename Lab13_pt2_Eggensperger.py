#Mariya Eggensperger 
#Lab 13_pt2 Submittal 
#CST 205-40 SpringB
#Adventure Game Extended with Lists


####on lists####
#becasue of the use of python dictionaries, it is not helpful to add lists everywhere
#the dict structure is actully helpful without the use of lists because i can change the items in the dict
#i could have done this another way, but this seemed to be pretty efficient without lists
...
def secretTravel(gameObject):
  printNow(" ")
  showInformation("The Queen is taken back by your advance, but she is pleased")
  showInformation("She opens a key and walks to a secret wardrobe, it's is cold")
  showInformation("Stepping into the wardrobe, you're suddently transported to another land")
  printNow(" ")
...
def takeAction(gameObject):
  ...
  #the next two if conditions uncover hidden objects and add them to the hidden objects property
    ...
    showInformation("While riding in your cab, you've found a secret item")
    showInformation("Take this object, The Beaded Seat Cover, to London to be used in the famous Black Taxis")
    ...
    showInformation("While sampling some fine wines, you've uncovered a secret item!")
    showInformation("Take this object, The Crystal Wine Goblet, to Milan to be given to a famous fashion designer")
  ...
  #the next two options are only shown to the player if the object has been found and add 1 point each to the victory condition
    ...
    showInformation("Congratulations, you've delivered the Beaded Seat Cover")
    showInformation("A revolution in taxi cab comfort will soon begin!")
    gameObject['victoryPoints'] = gameObject['victoryPoints'] + 1
  elif(playerAction == 'Gift the Goblet' and gameObject['currentNode'] == 'Milan'):
    showInformation("Congratulations, you've delivered the Wine Goblet")
    showInformation("The designer enjoyed your gift so much, /nshe is designing a clothing line in your image!")
    gameObject['victoryPoints'] = gameObject['victoryPoints'] + 1
  #lose condition
  elif(playerAction == 'Start a Tech Company' and gameObject['currentNode'] == 'San Francisco'):
    showInformation("Oooooh, ouch. You were gaining traction in the market but tried to go to big too soon")
    showInformation("Your investors went looking for other opportunities and pulled out.")
    printNow("************************************")
    printNow(" ")
...
gameObject['playerName'] = requestString("What is your name?")
...
while(gameObject['playing'] == true):
  ...
  printNow("**************************")
  printNow(" ")
  printNow("Welcome " + gameObject['playerName'] + " to " + gameObject['currentNode'])
  ...
  showInformation("It's now your turn to play.\n\nChoose an action from the following list:")
